...
> Favicon
Also called a _favorite icon_, the icon webpage. Browsers usually show these in a variety of places, such as next to the tab name. Favisons are created using the <link> tag. For example : 
